...
$opt_name = 'geniuscourse_options';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = [
	...
	// Указывает, должно ли отображаться меню администратора. Опции:: menu (отдельное меню) или submenu (в разделе "Внешний вид").
	'menu_type'                 => 'menu',

	// Показывать сабменю или нет.
	...
	// Подключать шрифтыс Google.
	'disable_google_fonts_link' => false,

	// Включюает меню в Админ баре.
	'admin_bar'                 => true,
	...
	// Режим разработчика. Пока работаем как разработчик - true. Как только передаем клиенту, на продажу - false
	'dev_mode'                  => true,
...
/// Табы на Админ баре. Мне не нужны, я их удаляю
...
/// Иконки на соцсети. Эта секция остается, но сюда нужно прописать свои соцсети.
// SOCIAL ICONS → Set up custom links in the footer for quick links in your panel footer icons.
// PLEASE CHANGE THESE SETTINGS IN YOUR THEME BEFORE RELEASING YOUR PRODUCT!!
// If these are left unchanged, they will not display in your panel!
$args['share_icons'][] = [
	'url'   => '//github.com/ReduxFramework/ReduxFramework',
	'title' => __('Visit us on GitHub', 'geniuscourses'),
	'icon'  => 'el el-github',
];
$args['share_icons'][] = [
	'url'   => '//www.facebook.com/pages/Redux-Framework/243141545850368',
	'title' => __('Like us on Facebook', 'geniuscourses'),
	'icon'  => 'el el-facebook',
];
$args['share_icons'][] = [
	'url'   => '//twitter.com/reduxframework',
	'title' => __('Follow us on Twitter', 'geniuscourses'),
	'icon'  => 'el el-twitter',
];
$args['share_icons'][] = [
	'url'   => '//www.linkedin.com/company/redux-framework',
	'title' => __('Find us on LinkedIn', 'geniuscourses'),
	'icon'  => 'el el-linkedin',
];


/// Вывод технической информации в разных местах: в подвале, в шапке...
/// Как правило разработчики отключают этот текст. Я его тоже удалю.
...
$help_tabs = [
	...
	/// Для эксперимента сделаю еще один хелп таб
	[
		'id'      => 'redux-help-tab-3',
		'title'   => esc_html__('3-Theme Information 2', 'geniuscourses'),
		'content' => '<p>' . esc_html__('3- This is the tab content, HTML is allowed.', 'geniuscourses') . '</p>',
	]
];
...
Redux::set_section(
	$opt_name,
	[
		/// < Angol. Меняю настройки: заголовок и id
		// 'title'            => esc_html__('Basic Fields', 'geniuscourses'),
		// 'id'               => 'basic',
		'title'            => esc_html__('Site Settings', 'geniuscourses'),
		'id'               => 'site_settings',
		'desc'             => esc_html__('These are really basic fields!', 'geniuscourses'),
		'customizer_width' => '400px',
		'icon'             => 'el el-car', /// Класс иконки взять из Elusive Icons (см. README.md).
	]
);

/// Вставляю код сабменю для секции Site Settings. Взять код из одного из подключаемых ниже файлов.
Redux::set_section(
	$opt_name,
	[
		'title'            => esc_html__('Header Section', 'geniuscourses'), /// Заголовок сабменю
		'id'               => 'site_settings-header', /// id сабменю
		'subsection'       => true, /// определение меню как сабменю
		'customizer_width' => '450px',
		'desc'             => esc_html__('Setting For Header: ', 'geniuscourses'),
		'fields'           => [ /// удаляю все поля из скопированного кода и буду писать свои
			[
				'id'           => 'logo', /// logo
				'type'         => 'media',
				'url'          => true,
				'title'        => esc_html__('The Site Logo', 'geniuscourses'),
				'compiler'     => 'true',
